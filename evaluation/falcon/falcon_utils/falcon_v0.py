...
#         self.n = CONST_N
#         self.sigma = Params[CONST_N]["sigma"]
#         self.sigmin = Params[CONST_N]["sigmin"]
#         self.signature_bound = Params[CONST_N]["sig_bound"]
#         self.sig_bytelen = Params[CONST_N]["sig_bytelen"]
#         self.h = public_key
...
#         hashed = [0 for i in range(CONST_N)]
#         i = 0
#         j = 0
#         while i < CONST_N:
...
#         hashed = PublicKey.hash_to_point(message, salt)
